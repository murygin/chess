...
public class User implements Serializable {
    ...
    private static final long serialVersionUID = 7707149013278740956L;
    public static final String ENGINE_USER = "Flux";
    public static final String ENGINE_EMAIL = "flux@this-is-not-an-email.com";
